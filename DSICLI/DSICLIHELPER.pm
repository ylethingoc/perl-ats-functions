package SonusQA::DSICLI::DSICLIHELPER;

=head1 NAME

 SonusQA::DSICLI::DSICLIHELPER - Perl module for Sonus Networks DSI CLI interaction
...
=head1 DESCRIPTION
 ...
 Items placed in this library are inherited by all versions of DSI CLI - they must be generic.
