package SonusQA::BSX::BSXHARNESS;
require Exporter;
...
SonusQA::BSX::BSXHARNESS - Perl module for BSX interaction

=head1 SYNOPSIS

   use ATS;  # This is the base class for Automated Testing Structure
   
   my $obj = SonusQA::BSX::BSXHARNESS->new(
                                   -suite   => __PACKAGE__,
...
=head1 DESCRIPTION
   ...
   This module provides an interface for Sonus BSX.
...
#################################################
    ...
    my ( $TestSuiteStartTime, $TestSuiteEndTime, $TestSuiteExecTime, $StartTimeReference );
    ...
    $TestSuiteExecTime = int tv_interval ($StartTimeReference);

    # mail the results after execution of testsuite
    &SonusQA::Utils::mail(
        'Results',           # File
        $suite_package,      # Test Suite
        $TestSuiteStartTime, # Start Time
        $TestSuiteEndTime,   # End Time
        $TestSuiteExecTime,  # Execution Time
    );
